...
public class Extract_DnoSalary extends Mapper<LongWritable, Text,Text, DoubleWritable> {
    /*
    ...
    Type Casting: department no. as String & salary as Double
    ...
    */
    public void map(LongWritable k, Text v, Context con) throws IOException, InterruptedException {
        ...
        con.write(new Text(sno), new DoubleWritable(sal));
    }
}