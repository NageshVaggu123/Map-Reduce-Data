...
public class Extract_SexDnoSalary extends Mapper<LongWritable, Text,Text, DoubleWritable> {
    /*
    ...
    Emp_Sex and Dno as Key, Emp_Salary as Value.
    ...
    */
    public void map(LongWritable k, Text v, Context con) throws IOException, InterruptedException {
        ...
        con.write(new Text(sexdno), new DoubleWritable(sal));
    }
}
